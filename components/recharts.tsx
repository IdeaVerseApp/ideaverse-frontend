...
// Create a dynamic wrapper for any other component that might be needed
export const createDynamicComponent = (componentName) => {
  return dynamic(() => 
    import("recharts").then(module => module[componentName]), 
    { ssr: false }
  );
} 